...
import { useLayout, ILayout, getLayout, LayoutSetup } from '../../../components/layout/core'
          ...
          <div className='card-body d-flex align-items-center py-8'>
            ...
            <div className='ms-6'>
              ...
              <p className='list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0'>
                ...
                <code>src/components/layout/core/DefaultLayoutConfig.ts</code> file). Don't forget
